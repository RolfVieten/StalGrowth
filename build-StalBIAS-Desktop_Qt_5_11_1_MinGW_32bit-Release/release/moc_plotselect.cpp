...
QT_INIT_METAOBJECT const QMetaObject PlotSelect::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_PlotSelect.data,
      qt_meta_data_PlotSelect,  qt_static_metacall, nullptr, nullptr}
};
...
void mycheck::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (mycheck::*)(bool , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mycheck::toggled)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject mycheck::staticMetaObject = {
    { &QCheckBox::staticMetaObject, qt_meta_stringdata_mycheck.data,
      qt_meta_data_mycheck,  qt_static_metacall, nullptr, nullptr}
};
