...
public:
    ...
    {
        CustomSeason->setWindowTitle(QApplication::translate("CustomSeason", "Dialog", nullptr));
        title->setText(QApplication::translate("CustomSeason", "Slow Growth Season Setup", nullptr));
        startl->setText(QApplication::translate("CustomSeason", "Start season", nullptr));
        Endl->setText(QApplication::translate("CustomSeason", "End season", nullptr));
        label->setText(QApplication::translate("CustomSeason", "<html><head/><body><p><span style=\" color:#ff0000;\">Start season date must be before end season date</span></p></body></html>", nullptr));
    } // retranslateUi
